...
def get_parser():
    ...
    parser.add_argument('--method', type=str, default="fedavg", help='choose what method to use.')
    parser.add_argument('--alpha', type=float, default=0.0, help='Hyperparameter alpha controls the correction term size.')
    return parser
