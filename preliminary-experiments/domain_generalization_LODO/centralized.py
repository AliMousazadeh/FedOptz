...
class Centralized:
    ...
    def train(self, net, data_loader, optimizer, loss_function, device = 'mps'):
        samples = 0
        cumulative_loss = 0
    ...
    def test(self, net, data_loader, loss_function, device='mps'):
        samples = 0
        cumulative_loss = 0
        cumulative_accuracy = 0
    ...
    def main_centralized(self, device='mps'):
